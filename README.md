...
- copy Palette functionality will create a file called palette.txt in the directory when the copy palette buttons are clicked
- type Ctrl + C to stop any program running in terminal when done
